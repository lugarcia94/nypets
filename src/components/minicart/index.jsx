        ...
        if(!parseInt(minicart.amount)) {
                        ...
                        <a className="minicart__link" href={url}>
                            ...
                            <span className="minicart__info">
                                ...
                                <span className="minicart__details">
                                    ...
                                    <span className="minicart__qty">qtd. {item.quantity}</span>
                                </span>
            ...
            footer = <footer className="minicart__footer">
                <div className="minicart__total">
                    <span className="minicart__total-label">Subtotal:</span>
                    <span className="minicart__total-price">R$ {total}</span>
                </div>
                <a href={ '/loja/carrinho.php?loja=' + this.props.id } className="minicart__finish" onClick={ () => {location.href = '/loja/carrinho.php?loja=' + this.props.id} }>
                    Ir para o carrinho
                </a>
            </footer>;
        }
